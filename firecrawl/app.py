...
def save_raw_data(raw_data, timestamp, output_folder='../../output/firecrawl'):
...
def save_formatted_data(formatted_data, timestamp, output_folder='../../output/firecrawl'):
    
    # Save the formatted data as JSON with timestamp in filename
    output_path = os.path.join(output_folder, f'sorted_data_{timestamp}.json'm)
